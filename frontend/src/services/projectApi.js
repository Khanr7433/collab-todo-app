...
const assignTaskToProject = (data) =>
  API.post("/api/projects/assign-task", data);
const addMemberToProject = (id, data) =>
  API.post(`/api/projects/${id}/add-member`, data);
const removeMemberFromProject = (id, data) =>
  API.post(`/api/projects/${id}/remove-member`, data);
