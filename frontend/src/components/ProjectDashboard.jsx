      ...
      <div className="relative bg-gradient-to-r from-gray-900 via-black to-gray-900 border border-gray-700 rounded-xl p-6 overflow-hidden">
        ...
        <div className="relative flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-400 mt-1">Manage and track your collaborative projects</p>
          </div>
          <div className="text-right">
            <p className="text-gray-300 font-medium">Welcome back,</p>
            <p className="text-blue-400 font-semibold text-lg">{user?.fullName}!</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
        <div className="group bg-black border border-gray-700 rounded-lg p-4 hover:border-gray-600 transition-all duration-200 hover:shadow-lg hover:shadow-white/5">
          <div className="flex items-center justify-between mb-2">
            <div className="text-2xl font-bold text-white group-hover:text-blue-400 transition-colors">{stats.total}</div>
          ...
          <div className="w-full bg-gray-800 rounded-full h-1.5 mt-3">
            <div className="bg-blue-600 h-1.5 rounded-full transition-all duration-300" style={{width: '100%'}}></div>
          </div>
        </div>
        ...
        <div className="group bg-black border border-gray-700 rounded-lg p-4 hover:border-green-600 transition-all duration-200 hover:shadow-lg hover:shadow-green-500/10">
          <div className="flex items-center justify-between mb-2">
            <div className="text-2xl font-bold text-green-400 group-hover:scale-105 transition-transform">{stats.active}</div>
          ...
          <div className="w-full bg-gray-800 rounded-full h-1.5 mt-3">
            <div className="bg-green-600 h-1.5 rounded-full transition-all duration-300" style={{width: stats.total > 0 ? `${(stats.active/stats.total)*100}%` : '0%'}}></div>
          </div>
        </div>
        ...
        <div className="group bg-black border border-gray-700 rounded-lg p-4 hover:border-blue-600 transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/10">
          <div className="flex items-center justify-between mb-2">
            <div className="text-2xl font-bold text-blue-400 group-hover:scale-105 transition-transform">{stats.completed}</div>
            <svg className="w-6 h-6 text-gray-500 group-hover:text-blue-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="w-full bg-gray-800 rounded-full h-1.5 mt-3">
            <div className="bg-blue-600 h-1.5 rounded-full transition-all duration-300" style={{width: stats.total > 0 ? `${(stats.completed/stats.total)*100}%` : '0%'}}></div>
          </div>
        </div>
        ...
        <div className="group bg-black border border-gray-700 rounded-lg p-4 hover:border-gray-500 transition-all duration-200 hover:shadow-lg hover:shadow-gray-500/10">
          <div className="flex items-center justify-between mb-2">
            <div className="text-2xl font-bold text-gray-400 group-hover:scale-105 transition-transform">{stats.archived}</div>
            <svg className="w-6 h-6 text-gray-500 group-hover:text-gray-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 8l6 6m0 0l6-6m-6 6V2" />
            </svg>
          </div>
          <div className="text-sm text-gray-400">Archived</div>
          <div className="w-full bg-gray-800 rounded-full h-1.5 mt-3">
            <div className="bg-gray-600 h-1.5 rounded-full transition-all duration-300" style={{width: stats.total > 0 ? `${(stats.archived/stats.total)*100}%` : '0%'}}></div>
          </div>
        </div>
        ...
        <div className="group bg-black border border-gray-700 rounded-lg p-4 hover:border-purple-600 transition-all duration-200 hover:shadow-lg hover:shadow-purple-500/10">
          <div className="flex items-center justify-between mb-2">
            <div className="text-2xl font-bold text-purple-400 group-hover:scale-105 transition-transform">{stats.owned}</div>
          ...
          <div className="w-full bg-gray-800 rounded-full h-1.5 mt-3">
            <div className="bg-purple-600 h-1.5 rounded-full transition-all duration-300" style={{width: stats.total > 0 ? `${(stats.owned/stats.total)*100}%` : '0%'}}></div>
          </div>
        </div>
        ...
        <div className="group bg-black border border-gray-700 rounded-lg p-4 hover:border-yellow-600 transition-all duration-200 hover:shadow-lg hover:shadow-yellow-500/10">
          <div className="flex items-center justify-between mb-2">
            <div className="text-2xl font-bold text-yellow-400 group-hover:scale-105 transition-transform">{stats.member}</div>
            <svg className="w-6 h-6 text-gray-500 group-hover:text-yellow-400 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
            </svg>
          </div>
          <div className="text-sm text-gray-400">Member</div>
          <div className="w-full bg-gray-800 rounded-full h-1.5 mt-3">
            <div className="bg-yellow-600 h-1.5 rounded-full transition-all duration-300" style={{width: stats.total > 0 ? `${(stats.member/stats.total)*100}%` : '0%'}}></div>
          </div>
        </div>
      </div>
        ...
        {recentProjects.length === 0 ? (
          <div className="text-center py-12 bg-gray-900/50 rounded-lg border border-gray-800">
            ...
            <p className="text-gray-400 text-sm max-w-sm mx-auto">
              Create your first project to start collaborating with your team and organizing your tasks.
            </p>
          </div>
        ) : (
      ...
      <div className="bg-black border border-gray-700 rounded-lg p-6 hover:border-gray-600 transition-all duration-200">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button className="group flex items-center gap-4 p-5 bg-gradient-to-r from-gray-900 to-gray-800 border border-gray-700 rounded-lg hover:border-blue-600 hover:from-blue-900/20 hover:to-gray-800 transition-all duration-200 text-left hover:shadow-lg hover:shadow-blue-500/10">
            ...
            <div className="flex-1">
              <div className="font-semibold text-white group-hover:text-blue-300 transition-colors">Create New Project</div>
              <div className="text-sm text-gray-400 mt-1 group-hover:text-gray-300 transition-colors">Start a new collaborative project</div>
            </div>
          ...
          <button className="group flex items-center gap-4 p-5 bg-gradient-to-r from-gray-900 to-gray-800 border border-gray-700 rounded-lg hover:border-green-600 hover:from-green-900/20 hover:to-gray-800 transition-all duration-200 text-left hover:shadow-lg hover:shadow-green-500/10">
            ...
            <div className="flex-1">
              <div className="font-semibold text-white group-hover:text-green-300 transition-colors">View All Tasks</div>
              <div className="text-sm text-gray-400 mt-1 group-hover:text-gray-300 transition-colors">Manage your tasks across projects</div>
            </div>
            <div className="opacity-0 group-hover:opacity-100 transition-opacity">
