    ...
    <div className="bg-black border border-gray-700 rounded-lg p-6 hover:border-gray-600 transition-all duration-200">
      ...
      <div className="space-y-3">
        {onlineUsers.map((userId, index) => (
          <div key={userId} className="group flex items-center p-3 bg-gray-900/50 rounded-lg border border-gray-700 hover:border-gray-600 transition-all duration-200">
